...
\usepackage[top=61mm, bottom=61mm, outer=45mm, inner=45mm]{geometry}
...
\pagestyle{plain}
\AddToShipoutPictureBG{\includegraphics[width=\paperwidth,height=\paperheight]{alchemy02.jpeg}}
...
\caption*{\bfseries h\hspace{15mm} i\hspace{15mm} l\hspace{15mm} s\hspace{15mm} t\hspace{15mm} q}
\end{figure}
...
\caption*{\footnotesize\bfseries ag.\hspace{2mm} berch.\hspace{2mm} cen.\hspace{4mm} derhu.\hspace{4mm} eg.\hspace{2mm} feu.\hspace{2mm} genue.\hspace{2mm} he.\hspace{7mm} cer.\hspace{2mm}  la...\footnote{The margin of the M. is cut.}}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{006-trans.png}
\caption*{\footnotesize\bfseries man.\hspace{2mm} net.\hspace{2mm} os.\hspace{2mm} perd.\hspace{2mm} cui.\hspace{5mm} rat.\hspace{3mm} sigil.\hspace{2mm} tir.\hspace{1mm} ur.\hspace{1mm} xen.\hspace{2mm} uir.}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=0.15\textwidth,keepaspectratio]{007-trans.png}
\caption*{\footnotesize\bfseries super su(nt)}
\end{figure}
\clearpage
\begin{table}[H]
    \centering
...
\end{figure}
{\footnotesize\bfseries alpha\hspace{2mm} beta \emph{vel} uita\hspace{2mm} gamma\hspace{2mm} delta\hspace{2mm} ebrachi\hspace{6mm} zita\hspace{4mm} ita}
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{027-trans.png}
\caption*{\footnotesize\bfseries a\hspace{18mm} b\hspace{12mm} g\hspace{14mm} d\hspace{10mm} e\hspace{14mm} z\hspace{4mm} i longum}
\end{figure}
{\footnotesize\bfseries\hspace*{39mm}(t)hita.\footnote{Margin of the MS. cut.}\hspace{5mm}  iota.}
\begin{figure}[H]
\centering
\includegraphics[width=0.25\textwidth,keepaspectratio]{028-trans.png}
\caption*{\footnotesize\bfseries th\hspace{10mm}  i}
\end{figure}
{\footnotesize\bfseries cappa\hspace{4mm} lappa\hspace{6mm} mi\hspace{12mm} ni\hspace{10mm} xi\hspace{6mm} brachi\hspace{6mm} pi\hspace{8mm} ro}
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{029-trans.png}
\caption*{\footnotesize\bfseries }
\end{figure}
{\footnotesize\bfseries\hspace*{40mm}(sig)ma\footnote{Margin of the MS. cut.} tau}
\begin{figure}[H]
\centering
\includegraphics[width=0.25\textwidth,keepaspectratio]{030-trans.png}
\end{figure}
{\footnotesize\bfseries uui\hspace{12mm} phi\hspace{18mm} chi\hspace{18mm} psi\hspace{12mm} oto\hspace{8mm} maga}
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,keepaspectratio]{031-trans.png}
\caption*{\footnotesize\bfseries \hspace*{28mm}f\hspace{18mm} ch\hspace{14mm} ps\hspace{15mm} o\hspace{10mm} magnum}
\end{figure}
